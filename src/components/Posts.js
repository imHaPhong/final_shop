      ...
      <Grid fluid>
        <Row gutter={0}>
          <Col md={6} xsHidden smHidden>
            <div className="boder" onSwipe={() => Alert.success("oke", 3000)}>
                ...
                <div className="post-left-header">
                  <div className="header-userinfo">
                    ...
                    <div className="user-avatar">
                      <img
                        src="http://f.imgs.vietnamnet.vn/2017/11/11/10/loat-anh-dang-yeu-cua-thanh-bieu-cam-don-tim-dan-mang-xu-han.jpg"
                        alt=""
                      />
                      <span>Anh Tuan</span>
                    </div>
          ...
          <Col xs={24} sm={24} md={6} smHidden xsHidden>
            <Widget title="Community Hashtags" />
            <Widget title="Latest Community Photos" />
          </Col>
        </Row>
      </Grid>
    </div>
